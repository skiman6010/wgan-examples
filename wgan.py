...
class WassersteinGAN(object):
    def __init__(self, g_net, d_net, x_sampler, z_sampler, data, model):
        ...
        def train(self, batch_size=64, num_batces=1000000):
            plt.ion()
            ...
            for _ in range(0, d_iters):
                ...
                self.sess.run(sef.d_clip)
                self.sess.run(self.d_rmsprop, feed_dict={self.z: bz, self.x: bx})
